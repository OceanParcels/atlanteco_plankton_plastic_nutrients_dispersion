...
output_file_path="/scratch/manra003/Plankton_withoutDVM_2D_1Y_150Prtdt1yr_z50.nc"
output_file = pset.ParticleFile(name=output_file_path, outputdt=timedelta(days=1))
