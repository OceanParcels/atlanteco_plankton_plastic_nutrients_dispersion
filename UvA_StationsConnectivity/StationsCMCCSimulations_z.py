...
simulation_end = datetime(2018, 1, 31, 12, 0, 0)
...
output_file = pset.ParticleFile(name="/scratch/dmanral/UvA_StationsCMCC_Jan2018_rtdt5d_z100m.nc", outputdt=timedelta(days=1))
