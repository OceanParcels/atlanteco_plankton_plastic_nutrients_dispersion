...
# home_folder = '/Users/dmanral/Desktop/Analysis/TARA/Task3_TM/Full_connectivity_output/'
...
data = np.load(home_folder + 'Stations_MinT_UvAconnectivity_nan2.npz', allow_pickle=True)
codes = data['codes']
...
ax = plt.gca()
ax.set_title(
    "Minimum Connectivity Time between all stations",
    pad=50)  # min/max Temperature: 15$^\circ$C to 35$^\circ$C Temperature range: 2$^\circ$C
...
plt.savefig(home_folder + "Stations_min-T_connectivity_nan2.pdf", bbox_inches='tight',
            pad_inches=0.2)
