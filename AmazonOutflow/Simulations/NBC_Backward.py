...
simulation_start = datetime(2016, 7, 15, 12, 0, 0)
simulation_end = datetime(2016, 7, 1, 12, 0, 0)
...
coords = pd.read_csv(r'/scratch/dmanral/data/Amazon_Retro_0625_FULL.csv')
...
output_file = pset.ParticleFile(name="/scratch/dmanral/Amazon_RetroBKsample_0625_v3_Jul15-01_2016_odt6h.nc", outputdt=timedelta(hours=6))
