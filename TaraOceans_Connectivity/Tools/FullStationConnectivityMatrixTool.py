...
def main():
    ...
    # domain_adjacency_file = 'ProcessedTM/Annual_Avg_Prob_Cutoff_pt01_csr.npz'
    domain_adjacency_file = 'ProcessedTM/Annual_Avg_DomainAdjacency_csr.npz'
    # domain_adjacency_file = 'ProcessedTM/Annual_Trahms_NORM_DomainAdjacency_csr.npz'

    temp_constraint_range = np.NaN
    min_accept_temp = np.NAN
    max_accept_temp = np.NAN
    # min_accept_temp = 15
    # max_accept_temp = 35.0
    prob_cutoff = np.NAN
    trahms2021 = False
    ...
    np.savez_compressed(
        home_folder + 'Full_connectivity_output/Stations_MTTcount_connectivity_TRange_2deg.npz',
