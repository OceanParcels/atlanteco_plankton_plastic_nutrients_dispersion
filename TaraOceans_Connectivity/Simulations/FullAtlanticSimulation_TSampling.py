...
simulation_start = datetime(2018, 2, 1, 12, 0, 0)
simulation_end = datetime(2018, 3, 1, 12, 0, 0)
...
output_file = pset.ParticleFile(name="/scratch/manra003/tara_res6_01/FullTara_Res6_TSample_Feb2018.nc", outputdt=timedelta((simulation_end-simulation_start).days))
