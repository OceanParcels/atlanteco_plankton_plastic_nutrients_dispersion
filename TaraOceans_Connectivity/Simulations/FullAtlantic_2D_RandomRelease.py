...
simulation_start = datetime(2009, 12, 15, 12, 0, 0)
simulation_end = datetime(2010, 1, 15, 12, 0, 0)
...
output_file = pset.ParticleFile(name="/scratch/manra003/tara_data_15/FullAtlantic_2D_15Dec2009_1month.nc", outputdt=timedelta((simulation_end-simulation_start).days))
