...
simulation_end = datetime(end_year, end_mon, start_day, 12, 0, 0)
...
output_file = pset.ParticleFile(name="/scratch/manra003/tara_res5_{0}/FullTara_Res5_TS_{0}{1}{2}_dt600.nc".format(start_day, mon, start_year), outputdt=timedelta((simulation_end-simulation_start).days))
