...
simulation_start = datetime(year, month, 1, 12, 0, 0)
simulation_end = datetime(year, month, 31, 12, 0, 0)
...
output_file = pset.ParticleFile(name="/nethome/manra003/analysis/dispersion/simulations/Benguela_0pt0625_FULLm_Oct01-30_2015.zarr", outputdt=timedelta(hours=6))
